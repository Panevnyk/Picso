...
public protocol AMessageTextInputViewDelegate: AnyObject {
    func textDidChangeManually(_ text: String)
}

public final class AMessageTextInputView: ABaseCustomView {
    // MARK: - Properties
    // UI
    ...
    // Delegate
    public weak var delegate: AMessageTextInputViewDelegate?
...
// MARK: - Public methods
public extension AMessageTextInputView {
    func showKeyboard() {
...
// MARK: - UI
private extension AMessageTextInputView {
    func setupUI() {
...
extension AMessageTextInputView: UITextViewDelegate {
